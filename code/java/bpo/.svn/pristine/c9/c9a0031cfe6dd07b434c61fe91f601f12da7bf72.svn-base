...
public class SysUserController extends BaseController {
    ...
    public Result insert(@RequestBody SysUserParam sysUserParam){
    ...
    public Result update(@RequestBody SysUserParam sysUserParam){
    ...
    @Log(title = "更新用户",businessType = BusinessType.UPDATE)
    @PreAuthorize("@ss.hasPermi('sysUser:update')")
    public Result updateUserStatus(@RequestBody SysUserParam sysUserParam){
        return sysUserService.updateUserStatus(sysUserParam);
    }
