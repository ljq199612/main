...
public class SysCompanyController extends BaseController {
   ...
   public Result findOrgType(){
    ...
    public Result findAllComByKey(Integer orgType, BaseEntity baseEntity){
        return sysCompanyService.findAllComByKey(orgType,baseEntity);
    }
    ...
    @Log(title = "更改组织状态",businessType = BusinessType.UPDATE)
    public Result updateStatus(SysCompanyParam sysCompanyParam){
            return sysCompanyService.updateStatus(sysCompanyParam);
    }
    ...
    public Result selectByProject(Integer projectId) {
        List<Map<String,Object>> list = sysCompanyService.selectByProject(projectId);
