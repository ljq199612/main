...
public class SecurityUtils
{
    ...
    public static String getUsername()
    {
        ...
        {
            throw new CustomException("获取用户账户异常", ResultConstants.IS_NOT_AUTHORIZED.getCode());
        }
    }
    ...
    public static LoginUser getLoginUser()
    {
        ...
        {
            throw new CustomException("获取用户信息异常", ResultConstants.IS_NOT_AUTHORIZED.getCode());
        }
    }
