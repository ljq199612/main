    ...
    " [t]>>  toggle
        nmap <Leader>tr :set norelativenumber ! relativenumber?<CR>       " 相对行号
        nmap <Leader>tn :set number ! nonumber?<CR>                       " 行号
        nmap <Leader>tl :set nowrap ! wrap?<CR>                           " 折行
        nmap <Leader>tt :set noignorecase ! ignorecase?<CR>               " 搜索时大小写
